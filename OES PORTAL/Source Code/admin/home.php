...
$sql5 = "select count(id) as id5 from teacher";
...
$sql6 = "select count(id) as id6 from department";
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $row5['id5']; ?></div>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-9 text-right">
                                                    <div class="huge"><?php echo $row6['id6']; ?></div>
                            ...
                            <div class="row" style="margin-left:auto">
                                <div class="col-lg-3 col-md-6" style="margin-left:4%">
                                    <div class="panel panel-primary">
                                        ...
                                        <a href="viewexam.php">
                                            <div class="panel-footer" style="margin-left:auto;">
                                                <span class="pull-left"> View Details</span>
                                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
