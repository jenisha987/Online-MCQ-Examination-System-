...
if (isset($_REQUEST['btn'])) {
    ...
    $result = $conn->query("select * from teacher where enroll=$enroll");
...
?>
    ...
    <?php
        ...
        $q = "insert into teacher(fname,lname,gender,enroll,branch,email,mobile,address,password,subject)
    values ('" . $_POST['fname'] . "','" . $_POST['lname'] . "','" . $_POST['gender'] . "','" . $_POST['enroll'] . "','" . $_POST['branch'] . "','" . $_POST['email'] . "','" . $_POST['mobile'] . "','" . $_POST['address'] . "','" . $_POST['password'] . "','" . $_POST['sub'] . "')";
...
<?php
        ...
        $pass = $_POST['password'];
        $q1 = "insert into teacherlogin(r_id, username, password) values ('$r_id', '$enroll','" . $pass . "')";
        $res1 = $conn->query($q1);
    }
}
...
<!-- <script type="text/javascript">
    function val() {
        ...
        var count = 0;
        if ((txtname.length != 12 && txtname.length > 0)) {
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Teacher Registration</h3>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="enroll" class="form-control" id="enrollmentNumber" placeholder="Enrollment No." required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Mobile*</label>
                                                    <input class="form-control" name="mobile" type="" placeholder="Enter Mobile Number" pattern="[0-9]+" maxlength="10" minlength="10" onkeypress="return isNumberKey(event)" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
